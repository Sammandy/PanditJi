...
function ManageAnushthaan() {
  const [anushthaanData, setAnushthaanData] = useState([
    {
      id: 1,
      serviceName: 'Anushthaan Ceremony 1',
      priest: '',
      completionStatus: 'Pending',
      description: 'This is the description for Anushthaan Ceremony 1.',
    },
    {
      id: 2,
      serviceName: 'Anushthaan Ceremony 2',
      priest: '',
      completionStatus: 'Pending',
      description: 'This is the description for Anushthaan Ceremony 2.',
    },
    {
      id: 3,
      serviceName: 'Anushthaan Ceremony 3',
      priest: '',
      completionStatus: 'Completed',
      description: 'This is the description for Anushthaan Ceremony 3.',
    },
  ]);
  ...
  const handleAssignPriest = (serviceId, priestId) => {
    setAnushthaanData(prevData =>
      prevData.map(service =>
        service.id === serviceId
          ? { ...service, priest: priests.find(priest => priest.id === priestId).name }
          : service
      )
    );
  };
  ...
  const handleDeleteService = (serviceId) => {
    setAnushthaanData(prevData => prevData.filter(service => service.id !== serviceId));
  ...
  const filteredData = filterStatus === 'All' ? anushthaanData : anushthaanData.filter(service => service.completionStatus === filterStatus);
    ...
    <div className="bg-gradient-to-r from-teal-50 to-white min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-extrabold text-center text-teal-800 mb-6">
          Manage Anushthaan Ceremonies
        </h1>
        <p className="text-center text-black mb-8">
          Manage and track the progress of Anushthaan ceremonies with ease.
        </p>
          ...
          <table className="min-w-full bg-white border border-black rounded-lg shadow-lg">
            <thead className="bg-teal-700 text-white">
              <tr>
                ...
                <th className="px-6 py-3 text-left">Assigned Priest</th>
            ...
            <tbody>
              {filteredData.map((service) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-black">{service.priest || 'Not Assigned'}</td>
                  ...
                  <td className="px-6 py-4">
                    <select
                      ...
                      value={priests.find(priest => priest.name === service.priest)?.id || ''}
                    >
        ...
        {selectedDescription && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md shadow-lg">
              <h2 className="text-lg font-bold mb-4 text-teal-800">Anushthaan Description</h2>
        ...
        {isDeleteModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md shadow-lg">
              ...
              <p className="text-black">Are you sure you want to delete this Anushthaan Ceremony?</p>
...
export default ManageAnushthaan;
